...
//        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-QBAUIQJE\\PIEMON;Initial Catalog=Sidergin_Website;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("workstation id=sidergin-websitedb.mssql.somee.com;packet size=4096;user id=UnnoUser_SQLLogin_1;pwd=jy4rydmdmg;data source=sidergin-websitedb.mssql.somee.com;persist security info=False;initial catalog=sidergin-websitedb;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.FaqId).HasName("PK__fqa__2FAB6E125DC366C2");
